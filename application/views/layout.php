...
if (isset($data)) {
    $nav_active_item = $data['active_page'];
}
...
<body>
    <script src="<?php echo $this->config->item('assets_url'); ?>js/demo-theme.min.js?1685976624"></script>
    <div class="page">
        <!-- Sidebar -->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="sidebar-menu">
                    <ul class="navbar-nav pt-lg-3">
                        <li class="nav-item <?php if ($nav_active_item == 'home') echo 'active'; ?> ">
                        ...
                        <li class="nav-item <?php if ($nav_active_item == 'prueba') echo 'active'; ?> dropdown">
                        ...
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    Copyright &copy; 2023
                                    <a href="." class="link-secondary">Octopus</a>.
                                    All rights reserved.
                                </li>
                                <li class="list-inline-item">
    ...
    <!-- Libs JS -->
    <script src="<?php echo $this->config->item('assets_url'); ?>libs/apexcharts/dist/apexcharts.min.js" defer></script>
    <script src="<?php echo $this->config->item('assets_url'); ?>libs/jsvectormap/dist/js/jsvectormap.min.js" defer></script>
    <script src="<?php echo $this->config->item('assets_url'); ?>libs/jsvectormap/dist/maps/world.js" defer></script>
    <script src="<?php echo $this->config->item('assets_url'); ?>libs/jsvectormap/dist/maps/world-merc.js" defer></script>
    <!-- Tabler Core -->
    <script src="<?php echo $this->config->item('assets_url'); ?>js/tabler.min.js" defer></script>
    <script src="<?php echo $this->config->item('assets_url'); ?>js/demo.min.js" defer></script>
</body>
